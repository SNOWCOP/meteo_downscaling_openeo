...
def run(spatial_extent):
    ...
    temporal_extent = ["2025-07-01","2025-07-05"]
    ...
    downscale_temperature_humidity(agera, dem, geopotential).execute_batch(format="GTiff", job_options={"executor-memory": "3G", "load_stac_apply_lcfm_improvements":True})
